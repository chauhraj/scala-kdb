...
public class c {
    ...
    static int[] sizeOf = {0, 1, 16, 0, 1, 2, 4, 8, 4, 8, 1, 0, 8, 4, 4, 8, 8, 4, 4, 4};
    static long t;
    ...
    public static int n(Object x) throws UnsupportedEncodingException {
        ...
        x instanceof char[] ? new String((char[]) x).getBytes(e).length :
        Array.getLength(x);
    }
    ...
    public static void set(Object x, int i, Object y) {
        Array.set(x, i, null == y ? NULL[typeOf(x)] : y);
    }
